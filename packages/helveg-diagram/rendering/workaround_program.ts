...
export abstract class WorkaroundProgram<
    ...
    constructor(
        ...
        this.pickProgram = pickingBuffer
            ? this.getProgramInfo(
                "pick",
                gl,
                prependPickingPrefix(def.VERTEX_SHADER_SOURCE),
                prependPickingPrefix(def.FRAGMENT_SHADER_SOURCE),
                pickingBuffer,
            )
            : null;
...
class _ProgramClass<
    ...
    E extends Attributes = Attributes,
    G extends Attributes = Attributes,
> extends WorkaroundProgram<Uniform, N, E, G> {
...
export type WorkaroundProgramType<
    Uniform extends string = string,
    N extends Attributes = Attributes,
    E extends Attributes = Attributes,
    G extends Attributes = Attributes,
