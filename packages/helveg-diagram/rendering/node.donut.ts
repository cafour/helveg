...
const UNIFORMS = ["u_sizeRatio", "u_pixelRatio", "u_correctionRatio", "u_matrix", "u_gap"];
...
export class DonutProgram extends HelvegNodeProgram<typeof UNIFORMS[number]> {
    ...
    setUniforms(params: RenderParams, programInfo: ProgramInfo): void {
        ...
        const { u_sizeRatio, u_pixelRatio, u_correctionRatio, u_matrix, u_gap } = uniformLocations;
