...
<button on:click={increment} class="btn-icon variant-ghost" type="button">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" style="height: 1.5em; overflow: visible">
    <defs>
